...
class BM25Search:
    ...
    def index(self, chunks: list[dict]) -> None:
        ...
        self.corpus_tokens = [segment_vietnamese(chunk["text"]).lower().split() for chunk in chunks]
    ...
    def search(self, query: str, top_k: int = BM25_TOP_K) -> list[SearchResult]:
        ...
        sorted_scored = sorted(scored_indices, key=lambda x: x[0], reverse=True)[:top_k]
        
        results = []
        for score, i in sorted_scored:
